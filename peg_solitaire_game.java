...
public static int readValidInt(Scanner in,String prompt,int min,int max)
{
    ...
    //CURRENTLY CHANGED FROM PREVIOUS VERSION OF THE CODE WRITTEN  CONSIDERING THE POSSIBILITY OF USER INPUTTING A VALUE OF A WRONG DATA TYPE
...
public static char[][] createBoard(int BoardType)
{
 ...
 public static int[] readValidMove(Scanner in,char[][] Board)
 {
    ...
    int row_n;
/*   
 * PREVIOUSLY WRITTEN WITHOUT CONSIDERING THE POSSIBILITY OF USER INPUTTING A VALUE OF A WRONG DATA TYPE
   row_n=in.nextInt(); 
